...
public class HTTPSClient extends Client {
	...
	public HTTPSClient(User user) {
		super(user);
	}

	public HTTPSClient(Cookie cookie, User user) {
		super(cookie, user);
	}
	...
	private Response react(HttpsURLConnection con) throws IOException {
		...
		return new Response(sb.toString(), con.getResponseCode(),
				con.getResponseMessage(), this.getHTTP());
	}

	private void request(HttpsURLConnection con, String method, Param query)
			throws IOException {
